...
public class HomeControllerTests{
    ...
    public void Can_Filter_Products()
    {
        ...
        // Act
        Product[] result = ((controller.Index("Cat2", 1) as ViewResult)?.ViewData.Model as ProductsListViewModel ?? new()).Products.ToArray();
    ...
    public void Generate_Category_Specific_Product_Count() {
        ...
        // Action
        int? res1 = GetModel(target.Index("Cat1") as ViewResult ?? new ViewResult())?.PagingInfo.TotalItems;
